- [One Memory Hub](topics/one-memory-hub.md) — updated 2026-09-26 — the hub gained tiered rules, an envelope, a self-test any chat can run, a tamper fingerprint, undo paths, and a private growth profile with a gate in code; details in the private repo
...
- [Claude Starter File](topics/claude-starter-file.md) — updated 2026-09-26 — share/hub-kit: HUB-KIT.md installs a hub with any AI (paper, local or cloud), consent card before every signup, human-step blocks, teaching, predictive answers, self-test and audit; both code levels 23/23
