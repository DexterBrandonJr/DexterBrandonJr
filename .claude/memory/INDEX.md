- [One Memory Hub](topics/one-memory-hub.md) — updated 2026-09-26 — hub_route sends a plain sentence to the right tool; a backlog the record writes and ranks (13 detectors, lenses, sizes with an executor); six public pages fetched and cleaned nightly; 70 checks, gate green
