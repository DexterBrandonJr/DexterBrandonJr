...
Fingerprint (SHA-256): `c323f5371fce7bef95e118de327813f338cdd06fef1054d06c15c20d37ec59df` · 62,507 bytes · tested on PostgreSQL 16 (self-test 24/24) · run it as one script.
...
Fingerprint (SHA-256): `c63329cf1010382b57b1114a2360b0493889c34152ec7e9e7f60a4beaaafd0fb` · 49,921 bytes · Python 3.8+, standard library only (self-test 24/24).
...
Fingerprint (SHA-256): `7c65a14651e2e4f0005af6aa8391fe765b9ff16c91ed24c681d244cdeeacdac8` · 9,756 bytes · Python 3.8+, standard library only · reads only the path it is given, writes only into the hub (local) or an SQL file (cloud), sends nothing.
